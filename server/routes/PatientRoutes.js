...
const {Signup, Signin, getPatient, deleteAllPatients, getSignedInPatientCNIC, getAllDoctors, updatePatient} = require('../contollers/PatientController');
const {addNote, getNote, removeNote} = require('../contollers/NoteController');

router.route('/signup').post(Signup);
router.route('/signin').post(Signin);
router.get('/home/:patientCNIC', getPatient);
router.route('/update/:patientCNIC').put(updatePatient);
